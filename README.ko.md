...
**해결하는 문제:** Claude Code가 작업 중 권한 확인이 필요할 때 터미널 앞에 없으면 그냥 조용히 멈춰버립니다. 돌아와 보면 작업이 한참 전에 멈춰 있는 경험, 다들 있을 겁니다. Relay는 작업이 일시 중지되는 순간 데스크톱 알림을 보내므로, 판단이 필요한 순간을 절대 놓치지 않습니다.
